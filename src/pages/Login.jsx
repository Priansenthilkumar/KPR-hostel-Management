...
export default function Login() {
  ...
  // Google Workspace SSO Modal State
  ...
  const handleVerifyGoogleAccount = async (emailToVerify) => {
    ...
    setTimeout(async () => {
      try {
        const res = await login(emailVal.fullEmail, 'sso_google_valid_token', activeTab);
      ...
      <div className="relative z-10 w-full max-w-[94vw] sm:max-w-[430px] bg-white/95 backdrop-blur-2xl rounded-3xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.35),0_0_30px_rgba(28,83,98,0.15)] border border-white/80 overflow-hidden flex flex-col my-auto text-gray-900 p-6 sm:p-8 transition-all duration-300">
        ...
        <div className="relative my-1">
            ...
            <button
              ...
              className="w-full h-11 rounded-xl bg-white border border-gray-300 hover:border-gray-400 hover:bg-gray-50/80 text-gray-800 text-xs font-bold flex items-center justify-center gap-2.5 shadow-sm transition-all active:scale-[0.98] group cursor-pointer"
            >
