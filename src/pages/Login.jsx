        ...
        {authMode !== 'forgot' && (
          <div className="w-full bg-gray-100 p-1 rounded-2xl flex mb-4 border border-gray-200">
            <button
              ...
              className={`flex-1 py-2 text-xs font-extrabold rounded-xl transition-all ${authMode === 'login'
            ...
            <button
              ...
              className={`flex-1 py-2 text-xs font-extrabold rounded-xl transition-all ${authMode === 'signup'
        ...
        {authMode !== 'forgot' && (
          <div className="w-full rounded-xl overflow-hidden border border-gray-300 flex mb-4 shadow-xs">
            <button
              ...
              className={`flex-1 py-2.5 px-0.5 text-[10.5px] sm:text-xs font-extrabold transition-all text-center leading-tight ${activeTab === 'mess_staff' ? 'bg-[#1C5362] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
            >
              Mess Staff
            </button>
            <button
              ...
              className={`flex-1 py-2.5 px-0.5 text-[10.5px] sm:text-xs font-extrabold transition-all text-center leading-tight ${authMode === 'signup' ? '' : 'border-x border-gray-300'
            ...
            {authMode !== 'signup' && (
              <button
                ...
                className={`flex-1 py-2.5 px-0.5 text-[10.5px] sm:text-xs font-extrabold transition-all text-center leading-tight ${activeTab === 'super_admin' ? 'bg-purple-800 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
              >
                Super Admin
              </button>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full h-11 pl-9 pr-9 text-xs rounded-xl bg-gray-50 border text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:bg-white font-medium transition-all ${email && !emailVal.isValid
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className={`w-full h-11 pl-9 pr-9 text-xs rounded-xl bg-gray-50 border text-gray-900 focus:outline-none focus:ring-2 focus:bg-white font-medium transition-all ${email && !emailVal.isValid
                      ? 'border-amber-400 focus:ring-amber-500'
                      : email && emailVal.isValid
                        ? 'border-emerald-500 focus:ring-emerald-600'
                        : 'border-gray-300 focus:ring-[#1C5362]'
                ...
                <div className="flex items-center gap-2 mt-1">
                  <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden flex gap-1">
                    {[1, 2, 3, 4].map((step) => (
                      <div
                        key={step}
                        className={`flex-1 h-full transition-all ${passStrength.score >= step ? passStrength.color : 'bg-transparent'
                          }`}
                      />
                    ))}
                  </div>
