...
export default function MobileBottomNav({ onOpenSidebar }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#0C242C]/95 backdrop-blur-xl border-t border-white/10 text-white md:hidden shadow-[0_-8px_20px_rgba(0,0,0,0.4)] transition-all">
      <div className="flex items-center justify-around h-16 px-2 max-w-md mx-auto">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center flex-1 h-full px-1 text-slate-400 hover:text-white transition-all cursor-pointer"
        >
          <div className="flex items-center justify-center w-10 h-7 rounded-full bg-white/10 text-white">
